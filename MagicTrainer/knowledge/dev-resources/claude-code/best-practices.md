...
<Tip>
  Create `SKILL.md` files in `.claude/commands/` to give Claude domain knowledge and reusable workflows.
</Tip>
...
Create a skill by adding a directory with a `SKILL.md` to `.claude/commands/`:

```markdown .claude/commands/api-conventions/SKILL.md theme={null}
---
...
```markdown .claude/commands/fix-issue/SKILL.md theme={null}
---
name: fix-issue
