<!-- Judging at Regular REL — scraped from blogs.magicjudges.org/rules/jar/ | Retrieved 2026-07-03 -->

# Judging at Regular Rules Enforcement Level

_Effective August 5, 2024  
...
[](https://media.wizards.com/ContentResources/WPN/MTG_JAR_2024Aug2_EN.pdf)

## **[  
JAR Download](https://media.wizards.com/ContentResources/WPN/MTG_JAR_2024Aug2_EN.pdf)**
...
The priority is to educate players who exhibit these behaviors. It can be useful to reinforce this education with a Game Loss should the unwanted behaviour continue. Intentionally taking any of these actions when the player knows it is against the rules, or trying to trick their opponent into doing so, is a Serious Problem.
...
Certain actions will not be tolerated under any circumstances. Every effort should be made to educate players before and during events but any player engaging in the following must be removed from your event and, at the Organizer's discretion, removed from the venue entirely:
  ...
  * Aggressive, violent, harassing or abusive behavior (physical or verbal). this includes insults based on race, color, religion, national origin, age, gender, disability, or sexual orientation, and intentional misgendering.
...
Removing players in this way is called a Disqualification, and we must always try to educate our players on why these actions are unacceptable. Also let the player know that while your decision is final, Wizards of the Coast would still like to hear their side of the story. Disqualifications should be reported [here](https://askwpn-na.wizards.com/hc/en-us/requests/new?ticket_form_id=360001446253). Please include the Wizards Account email address of the disqualified player and that player's opponent.

## Resources

**Got questions?** Try [chat.magicjudges.org](http://chat.magicjudges.org) or asking in the #mtg_rules_chat channel in the [Magic: The Gathering Official server on Discord](https://discord.com/invite/wizards-magic).

The [Magic Tournament Rules](http://blogs.magicjudges.org/rules/mtr/) give more information about how to run tournaments at any REL, and can be found at: <http://wpn.wizards.com/en/rules-documents>.
...
[Need help with your own blog? Contact us!](http://blogs.magicjudges.org/help/)
